...
export const Button = <C extends ElementType = "button">({
  ...
  return (
    <Component
      className={clsx(
        // Common styles
        "font-sans font-medium px-4 py-2 text-sm text-center min-w-[72px] rounded-full border-2 outline-none transition-colors focus-visible:ring-offset-2 focus-visible:ring-2 focus-visible:ring-sky-500 dark:focus-visible:ring-sky-300 dark:ring-offset-slate-900 disabled:text-slate-300 dark:disabled:text-slate-400 disabled:bg-slate-100 disabled:border-slate-100 dark:disabled:bg-slate-600 dark:disabled:border-slate-600",
        // Primary
        variant === "primary" &&
